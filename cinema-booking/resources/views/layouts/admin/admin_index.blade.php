    ...
    <section class="conf-step">
      ...
      <div class="conf-step__wrapper">
          ...
          <div class="conf-step__legend">
              <label class="conf-step__label">Рядов: <input type="number" id="rows-count" class="conf-step__input" min="1" value="10"></label>
              <span class="multiplier">x</span>
              <label class="conf-step__label">Мест: <input type="number" id="seats-count" class="conf-step__input" min="1" value="8"></label>
    ...
    <section class="conf-step">
      ...
      <div class="conf-step__wrapper">
        ...
        <fieldset class="conf-step__buttons text-center">
          ...
          <input type="submit" id="create-pricehall" value="Сохранить" class="conf-step__button conf-step__button-accent">
        </fieldset>  
      </div>
    </section>
    ...
    <section class="conf-step">
      ...
      <div class="conf-step__wrapper">
          ...
          <div class="conf-step__add-movie">
            ...
            <input type="text" id="movie-title" placeholder="Введите название">

            <label for="movie-duration">Продолжительность (мин):</label>
            <input type="number" id="movie-duration" placeholder="Введите продолжительность">
